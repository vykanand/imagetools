...
const PAGE_NAMES = { 'remove-background': 'Background Remover', 'resize-image': 'Image Resizer', 'image-filter': 'Image Filter Editor', 'background-blur': 'Background Blur', 'selfie-filter': 'Selfie Filter', 'image-uploader': 'Image Uploader', 'online-camera': 'Online Camera', 'api-documentation': 'API Documentation' };

// SPA routes — inject SEO meta and serve index.html
app.get(['/remove-background','/resize-image','/image-filter','/background-blur','/selfie-filter','/image-uploader','/online-camera','/api-documentation'], (req, res) => {
...
app.get('/sitemap.xml', (req, res) => {
  ...
  const pages = ['remove-background','resize-image','image-filter','background-blur','selfie-filter','image-uploader','online-camera','api-documentation'];
